                ...
                <div className="flex">
                    ...
                    <div className="basis-1/4 px-2">
                        <div className="space-y-4">
                            ...
                            {selectedImage ? <>
                                <textarea
                                    className='resize-none w-full bg-transparent rounded border-2 border-secondary-dark focus:border-primary-dark focus:ring-1 text-primary dark:text-primary-dark h-32 p-1' placeholder='Alt text'
                                    value={altText}
                                ...
                                <div className="relative aspect-video bg-png-pattern">
                                    <Image src={selectedImage} layout='fill' alt='gallery' objectFit='contain' />
                                </div>  </> : null}
                        </div>
                    </div>
                </div>
